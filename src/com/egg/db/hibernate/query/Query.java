...
public class Query {
	...
	// operator : =, !=, >, >=, <, <=, like, between, in, not in, is null, is
	// not null
	 ...
	 * 条件语句：and condition
	 */
	public Query and(String condition, String[] paramKeys, Object[] paramVals) {
		if (isBlank(condition)) {
			return this;
		}
		...
		return addWhereParam(paramKeys, paramVals);
	}

	/**
	 * 条件语句：and condition
	 */
	public Query and(String condition, Map<String, Object> params) {
		if (isBlank(condition)) {
			return this;
		}
	...
	public Query addWhereParam(Map<String, Object> params) {
		if (params == null || params.isEmpty()) {
			return this;
		}
		whereParams.putAll(params);
		return this;
	}

	public Query addWhereParam(String key, Object val) {
		if (isBlank(key)) {
			return this;
		}
		whereParams.put(key, val);
		return this;
	}

	public Query addWhereParam(String[] keys, Object[] vals) {
		...
		for (int kInd = 0, vInd = 0; kInd < kLen && vInd < vLen; kInd++, vInd++) {
			whereParams.put(keys[kInd], vals[vInd]);
		}
		return this;
	}
